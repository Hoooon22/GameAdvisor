...
set CLASSPATH=%APP_HOME%\lib\client-0.1.0-SNAPSHOT.jar;%APP_HOME%\lib\javafx-controls-21.0.1-win.jar;%APP_HOME%\lib\javafx-graphics-21.0.1-win.jar;%APP_HOME%\lib\oshi-core-6.4.4.jar;%APP_HOME%\lib\javafx-base-21.0.1-win.jar;%APP_HOME%\lib\jna-platform-5.13.0.jar;%APP_HOME%\lib\jna-5.13.0.jar;%APP_HOME%\lib\slf4j-api-2.0.7.jar
